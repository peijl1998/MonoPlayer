...
const DASHMetrics* MultimediaStream::GetMetrics() {
    return this->dashMetrics;
}

void MultimediaStream::UpdateMetrics() {
    this->dashManager->UpdateMetrics();
}
