...
#include "../libdashframework/Input/DASHMetrics.h"
    ...
    namespace managers
    {
        class MultimediaManager : public IStreamObserver
        {
            ...
            private:
                ...
                bool StartVideoMonitorThread();
                bool StartAudioMonitorThread();
                void StopMonitorThread(const std::string&);
                static void* MonitorVideo(void* data);
                static void* MonitorAudio(void* data);
                static void Monitor(MultimediaManager*, const std::string&);
                THREAD_HANDLE videoMonitorHandle;
                THREAD_HANDLE audioMonitorHandle;
                bool isVideoMonitoring;
                bool isAudioMonitoring;
