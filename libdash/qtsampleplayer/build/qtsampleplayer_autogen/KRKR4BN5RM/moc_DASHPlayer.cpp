...
void sampleplayer::DASHPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DASHPlayer::VideoSegmentBufferFillStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (DASHPlayer::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DASHPlayer::VideoBufferFillStateChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (DASHPlayer::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DASHPlayer::AudioSegmentBufferFillStateChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (DASHPlayer::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DASHPlayer::AudioBufferFillStateChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject sampleplayer::DASHPlayer::staticMetaObject = {
    { &IDASHPlayerGuiObserver::staticMetaObject, qt_meta_stringdata_sampleplayer__DASHPlayer.data,
      qt_meta_data_sampleplayer__DASHPlayer,  qt_static_metacall, nullptr, nullptr}
};
...
void *sampleplayer::DASHPlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "managers::IMultimediaManagerObserver"))
        return static_cast< managers::IMultimediaManagerObserver*>(this);
